...
import { LayoutDashboard, ShoppingBag, Package, Users, Settings, LogOut, Truck, Image } from "lucide-react";
...
export function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-background border-r border-border/20 flex flex-col z-[100]">
      <div className="h-24 px-8 flex flex-col justify-center border-b border-border/20">
